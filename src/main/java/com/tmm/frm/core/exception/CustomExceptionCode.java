...
public enum CustomExceptionCode {
	...
	ACC001_INVALIDPROVIDER("ACC001", "Invalid BankProvider - Account is corrupted or erroneus"),
	UPLOAD01_FILEERROR("UPLOAD01", "Error loading data from uploaded file. Maybe corrupt or invalid");
