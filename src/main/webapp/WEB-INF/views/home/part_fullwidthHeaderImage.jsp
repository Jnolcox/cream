	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8" style="padding-top: 120px;">
				<h1 style="font-weight: 700; font-size: 3.2em;"><span class="header-highlight">CREAM</span></h1>
				<h2 style="font-weight: 100; font-size: 2.8em;"><span class="header-highlight">Cash rules everything around me</span></h2>
				<h2 style="font-weight: 100; font-size: 2.8em;"><span class="header-highlight">It's all about the money, dollar dollar bill yo.</span></h2>
			</div>
